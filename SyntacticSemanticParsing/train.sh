...
log_file=${curr_dir}/log/${form}.init_lr${eta0}.lstm${lstm_dim}.mlp${mlp_dim}.pos${pos_dim}.wdrop${word_dropout}.proj${proj}.sa${struct_att}
...
for form in $forms; do
    ...
    --dependency_file_test=${dependency_file_dev} \
