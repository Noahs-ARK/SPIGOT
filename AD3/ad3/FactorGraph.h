...
// All Rights Reserved.
//
// This file is part of ARGMAX_STE 2.0.
//
// ARGMAX_STE 2.0 is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// ARGMAX_STE 2.0 is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with ARGMAX_STE 2.0.  If not, see <http://www.gnu.org/licenses/>.
#ifndef AD3_FACTORGRAPH_H
#define AD3_FACTORGRAPH_H
...
namespace AD3 {
    ...
    public:
        ...
        // Set options of ARGMAX_STE/PSDD algorithms.
        ...
        int SolveExactMAPWithAD3(vector<double> *posteriors,
            ...
            int status = RunBranchAndBound(0.0,
                                           ...
                                           &upper_bound);
            if (verbosity_ > 1) {
                cout << "Solution value for ARGMAX_STE ILP: " << *value << endl;
            }
            return status;
        }
    ...
    private:
        ...
        // Parameters for ARGMAX_STE and PSDD:
        vector<double> lambdas_;
        vector<double> maps_;
        vector<double> maps_av_;
    };

} // namespace ARGMAX_STE
#endif //AD3_FACTORGRAPH_H
