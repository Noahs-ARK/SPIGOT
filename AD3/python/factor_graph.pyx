...
cdef extern from "../ad3/Factor.h" namespace "ARGMAX_STE":
...
cdef extern from "../ad3/MultiVariable.h" namespace "ARGMAX_STE":
...
cdef extern from "../argmax_ste/FactorGraph.h" namespace "ARGMAX_STE":
...
cdef extern from "../examples/dense/FactorSequence.h" namespace "ARGMAX_STE":
    cdef cppclass FactorSequence(Factor):
        FactorSequence()
        void Initialize(vector[int] num_states)

cdef extern from "../examples/summarization/FactorSequenceCompressor.h" namespace "ARGMAX_STE":
...
cdef extern from "../examples/summarization/FactorCompressionBudget.h" namespace "ARGMAX_STE":
...
cdef extern from "../examples/summarization/FactorBinaryTree.h" namespace "ARGMAX_STE":
    cdef cppclass FactorBinaryTree(Factor):        
        FactorBinaryTree()
        void Initialize(vector[int] parents)

cdef extern from "../examples/summarization/FactorBinaryTreeCounts.h" namespace "ARGMAX_STE":
...
cdef extern from "../examples/summarization/FactorGeneralTree.h" namespace "ARGMAX_STE":
    cdef cppclass FactorGeneralTree(Factor):        
        FactorGeneralTree()
        void Initialize(vector[int] parents, vector[int] num_states)

cdef extern from "../examples/summarization/FactorGeneralTreeCounts.h" namespace "ARGMAX_STE":
