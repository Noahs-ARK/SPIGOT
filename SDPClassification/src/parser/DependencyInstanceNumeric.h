...
public:
    ...
    void Set(const vector<int> &form_ids,
             const vector<int> &form_lower_ids,
             const vector<int> &lemma_ids,
             const vector<int> &pos_ids,
             const vector<int> &cpos_ids) {
        form_ids_ = form_ids;
        form_lower_ids_ = form_lower_ids;
        lemma_ids_ = lemma_ids;
        pos_ids_ = pos_ids;
        cpos_ids_ = cpos_ids;
    };
