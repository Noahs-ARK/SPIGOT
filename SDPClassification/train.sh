...
log_file=${curr_dir}/log/${classification_trainer}.init_lr${classification_eta0}.halve${classification_halve}.mlp${classification_mlp_dim}.lstm${classification_lstm_dim}.wdrop${classification_word_dropout}.dropout${classification_dropout}.proj${proj}
...
--classification_file_test=${classification_file_dev} \
